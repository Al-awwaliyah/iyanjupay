...
>
{isSuperAdmin ? ( <ShieldCheck className="h-3.5 w-3.5" />
...
return ( <AdminLayout> <div className="min-h-screen bg-slate-50"> <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
{toast && ( <div className="fixed right-4 top-4 z-[100] w-[min(420px,calc(100vw-2rem))]">
<Alert
variant={
toast.type ===
"error"
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500">
              The administrator's last name will be
              used to generate the temporary password.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500">
              Login credentials will be sent to this
              email address.
            </p>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              automatically after the account is
              created. The temporary password is based
              on their last name and ends with{" "}
              <strong>
                @123
              </strong>
              .
        ...
        <div className="space-y-4">
          ...
          {newRole ===
            ...
            <Alert>
              ...
              <AlertDescription>
                This role grants the administrator full
                access to privileged management
                operations.
              </AlertDescription>
            </Alert>
          )}
