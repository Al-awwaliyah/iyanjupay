...
const [updatingConversation, setUpdatingConversation] =
useState(false);
...
channel.on(
  ...
  async (payload) => {
    ...
    // Automatically mark incoming USER messages as read.
    if (
...
```
  ...
  try {
    ...
    // Admin has replied, so conversation is now
...
if (authLoading) {
return ( <div className="min-h-screen bg-gray-50 flex items-center justify-center"> <div className="text-center"> <Loader2 className="h-10 w-10 animate-spin text-purple-600 mx-auto" />
...
return ( <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50 flex items-center justify-center p-6"> <div className="max-w-md w-full bg-white border rounded-2xl shadow-lg p-8 text-center">
...
```
      ...
      <p className="text-sm text-gray-500 mt-2">
        Your account does not have active administrator access to the IyanjuPay support dashboard.
      </p>
        ...
        {conversationsLoading ? (
          ...
          <div className="h-full flex flex-col items-center justify-center px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              There are no support conversations matching your filters.
            </p>
      ...
      {!selectedConversation ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
          ...
          <p className="text-sm text-gray-500 mt-2 max-w-md">
            Select a conversation from the inbox to view the customer messages and respond in realtime.
          </p>
